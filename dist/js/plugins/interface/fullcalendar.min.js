...
(function (t, e) {
      ...
      return o && t.each(o.split(" "), function (e) {
        ...
        t.each(this.split(","), function (e, i) {
          if ("title" == i) a.append("<span class='fc-header-title'><h2>&nbsp;</h2></span>"), o && o.addClass(v + "-corner-right"), o = null;else {
            ...
            if (n[i] ? s = n[i] : me[i] && (s = function s() {
  ...
  function o(n, r) {
    ...
    function s(r, a) {
      ...
      for (o = 0; l.length > o; o++) {
        ...
        if ("object" == _typeof(i)) return s(i, a), e;
      }
    ...
    function c(n) {
      return t.isFunction(n) || t.isArray(n) ? n = {
        ...
        url: n
      }), "object" == _typeof(n) ? (D(n), F.push(n), n) : e;
    }
    ...
    function D(t) {
      ...
      for (var e = pe.sourceNormalizers, n = 0; e.length > n; n++) {
        e[n](t);
      }
    }
    ...
    function C(t) {
      return ("object" == _typeof(t) ? t.events || t.url : "") || t;
    }
  ...
  function p(t, n) {
    return "object" == _typeof(t) ? t : "number" == typeof t ? new Date(1e3 * t) : "string" == typeof t ? t.match(/^\d+(\.\d+)?$/) ? new Date(1e3 * parseFloat(t)) : (n === e && (n = !0), m(t, n) || (t ? new Date(t) : null)) : null;
  }
  ...
  function y(t) {
    ...
    if ("object" == _typeof(t)) return 60 * t.getHours() + t.getMinutes();
  ...
  function Z(e, n, r) {
    ...
    function u() {
      ...
      for (r += "<thead><tr>", pe && (r += "<th class='fc-week-number " + n + "'>" + Y(me) + "</th>"), t = 0; ne > t; t++) {
        e = Te(0, t), r += "<th class='fc-day-header fc-" + De[e.getDay()] + " " + n + "'>" + Y(ke(e, ge)) + "</th>";
      }
    ...
    function v() {
      ...
      for (a += "<tbody>", t = 0; ee > t; t++) {
        for (a += "<tr class='fc-week'>", pe && (n = Te(t, 0), a += "<td class='fc-week-number " + r + "'>" + "<div>" + Y(ke(n, ye)) + "</div>" + "</td>"), e = 0; ne > e; e++) {
          n = Te(t, e), a += h(n);
        }
  ...
  function K(n, r, a) {
    ...
    function g() {
      ...
      for (a += "<thead><tr>", Je ? (e = sn(t, Ue), Pe ? e += Ve : e = Ve + e, a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + Y(e) + "</th>") : a += "<th class='fc-agenda-axis " + r + "'>&nbsp;</th>", n = 0; Ae > n; n++) {
        t = rn(0, n), a += "<th class='fc-" + De[t.getDay()] + " fc-col" + n + " " + r + "'>" + Y(sn(t, Xe)) + "</th>";
      }
    ...
    function p() {
      ...
      for (l += "<tbody><tr><th class='fc-agenda-axis " + o + "'>&nbsp;</th>", n = "", e = 0; Ae > e; e++) {
        t = rn(0, e), a = ["fc-col" + e, "fc-" + De[t.getDay()], i], +t == +s ? a.push(Be + "-state-highlight", "fc-today") : s > t ? a.push("fc-past") : a.push("fc-future"), r = "<td class='" + a.join(" ") + "'>" + "<div>" + "<div class='fc-day-content'>" + "<div style='position:relative'>&nbsp;</div>" + "</div>" + "</div>" + "</td>", n += r;
      }
  ...
  function te() {
    ...
    function s(n, r) {
      ...
      for (z[0].innerHTML = N, D = z.children(), a = 0; H > a; a++) {
        o = n[a], i = o.event, w = t(D[a]), C = b("eventRender", i, i, w), C === !1 ? w.remove() : (C && C !== !0 && (w.remove(), w = t(C).css({
          position: "absolute",
          top: o.top,
          left: o.left
      ...
      for (E(z, n, f), a = 0; H > a; a++) {
        o = n[a], (w = o.element) && (o.vsides = R(w, !0), o.hsides = x(w, !0), M = w.find(".fc-event-title"), M.length && (o.contentTop = M[0].offsetTop));
      }

      for (a = 0; H > a; a++) {
        o = n[a], (w = o.element) && (w[0].style.width = Math.max(0, o.outerWidth - o.hsides) + "px", T = Math.max(0, o.outerHeight - o.vsides), w[0].style.height = T + "px", i = o.event, o.contentTop !== e && 10 > T - o.contentTop && (w.find("div.fc-event-time").text(ie(i.start, y("timeFormat")) + " - " + i.title), w.find("div.fc-event-title").remove()), b("eventAfterRender", i, i, w));
      }
    }
  ...
  function ee(t) {
    ...
    for (e = 0; s > e; e++) {
      for (n = t[e], r = 0;;) {
        if (a = !1, i[r]) for (o = 0; i[r].length > o; o++) {
          if (re(i[r][o], n)) {
            a = !0;
            break;
          }
  ...
  function ae(n, r, a) {
    ...
    function S(t) {
      return "object" == _typeof(t) && (t = t.getDay()), Q[t];
    }
