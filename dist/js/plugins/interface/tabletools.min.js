  ...
  var r = function r(n) {
    ...
    g.Client.prototype = {
      ...
      receiveEvent: function receiveEvent(a, b) {
        ...
        if (this.handlers[a]) for (var d = 0, f = this.handlers[a].length; d < f; d++) {
          ...
          if ("function" == typeof e) e(this, b);else if ("object" == _typeof(e) && 2 == e.length) e[0][e[1]](this, b);else if ("string" == typeof e) m[e](this, b);
        }
      }
    };
    ...
    _TableTools.prototype = {
      ...
      _fnPrintStart: function _fnPrintStart(a) {
        ...
        for (f in d) {
          if ("i" != f && "t" != f && 1 == f.length) for (var i = 0, g = d[f].length; i < g; i++) {
    ...
    "function" == typeof e.fn.dataTable && "function" == typeof e.fn.dataTableExt.fnVersionCheck && e.fn.dataTableExt.fnVersionCheck("1.9.0") ? e.fn.dataTableExt.aoFeatures.push({
      fnInit: function fnInit(a) {
        var b = a.oInit,
            a = new _TableTools(a.oInstance, b ? b.tableTools || b.oTableTools || {} : {});
    ...
    n.fn.dataTable.TableTools = _TableTools;
    return n.fn.DataTable.TableTools = _TableTools;
  };
