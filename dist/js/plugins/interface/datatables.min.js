...
(function (za, N, l) {
  var M = function M(g) {
    ...
    function Aa(a, b) {
      ...
      a.aoColumns.push(c);
      c = a.aoPreSearchCols;
      c[d] = g.extend({}, _p.models.oSearch, c[d]);
      fa(a, d, null);
    }
    ...
    function fa(a, b, c) {
      ...
      c !== l && null !== c && (db(c), G(_p.defaults.column, c), c.mDataProp !== l && !c.mData && (c.mData = c.mDataProp), c.sType && (d._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), g.extend(d, c), D(d, c, "sWidth", "sWidthOrig"), "number" === typeof c.iDataSort && (d.aDataSort = [c.iDataSort]), D(d, c, "aDataSort"));
    ...
    function Eb(a, b) {
      ...
      for (var f, h = _p.ext.type.order[c.sType + "-pre"], g = 0, j = a.aoData.length; g < j; g++) {
    ...
    function O(a, b, c, d) {
      ...
      if (b) za.console && console.log && console.log(c);else if (a = _p.ext, "alert" == (a.sErrMode || a.errMode)) alert(c);else throw Error(c);
    }
    ...
    function Jb(a) {
      return function () {
        var b = [ua(this[_p.ext.iApiIndex])].concat(Array.prototype.slice.call(arguments));
    ...
    _p = function p(a) {
      ...
      this.each(function () {
        ...
        if ("table" != this.nodeName.toLowerCase()) O(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);else {
          ...
          if (null === n || "" === n) this.id = n = "DataTables_Table_" + _p.ext._unique++;
          ...
          n = k.oClasses;
          h.bJQueryUI ? (g.extend(n, _p.ext.oJUIClasses, h.oClasses), h.sDom === m.sDom && "lfrtip" === m.sDom && (k.sDom = '<"H"lfr>t<"F"ip>'), k.renderer) ? g.isPlainObject(k.renderer) && !k.renderer.header && (k.renderer.header = "jqueryui") : k.renderer = "jqueryui" : g.extend(n, _p.ext.classes, h.oClasses);
          ...
          if (h.aaData) for (i = 0; i < h.aaData.length; i++) {
            H(k, h.aaData[i]);
    ...
    _q.prototype = {
      ...
      filter: function filter(a) {
        var b = [];
        if (v.filter) b = v.filter.call(this, a, this);else for (var c = 0, d = this.length; c < d; c++) {
      ...
      map: function map(a) {
        var b = [];
        if (v.map) b = v.map.call(this, a, this);else for (var c = 0, d = this.length; c < d; c++) {
    ...
    _p.isDataTable = _p.fnIsDataTable = function (a) {
      var b = g(a).get(0),
          c = !1;
      g.each(_p.settings, function (a, e) {
    ...
    _p.render = {
      number: function number(a, b, c, d) {
        return {
