...
!function ($) {
  ...
  Colorpicker.prototype = {
    ...
    setValue: function setValue(newColor) {
    ...
    previewColor: function previewColor() {
      ...
      this.base.backgroundColor = this.color.toHex(this.color.value.h, 1, 1, 1); //set te color for alpha slider
    ...
    mousedown: function mousedown(e) {
      ...
      if (!zone.is('.colorpicker')) {
        ...
        var offset = zone.offset(); //reference to knob's style
