...
window.rangy = function () {
  ...
  function c(a, b) {
    return !!(_typeof(a[b]) == h && a[b]);
  }

  function a(a, b) {
    return _typeof(a[b]) != j;
  }
  ...
  o.warn = function (a) {
    a = "Rangy warning: " + a;
    o.config.alertOnWarn ? window.alert(a) : _typeof(window.console) != j && _typeof(window.console.log) != j && window.console.log(a);
  };
...
rangy.createModule("DomUtil", function (b, c) {
  ...
  function i(a) {
    ...
    if (_typeof(a.ownerDocument) != p) return a.ownerDocument;
    if (_typeof(a.document) != p) return a.document;
  ...
  k.prototype = {
    ...
    next: function next() {
      ...
      if (this._current) {
        b = a.firstChild;
        if (!b) for (b = null; a !== this.root && !(b = a.nextSibling);) {
          a = a.parentNode;
        }
        this._next = b;
      }
  ...
  b.dom = {
    arrayContains: m,
    isHtmlNamespace: function isHtmlNamespace(a) {
      var b;
      return _typeof(a.namespaceURI) == p || null === (b = a.namespaceURI) || "http://www.w3.org/1999/xhtml" == b;
    },
    ...
    getNodeIndex: a,
    getNodeLength: function getNodeLength(a) {
      var b;
      return f(a) ? a.length : (b = a.childNodes) ? b.length : 0;
    },
    getCommonAncestor: d,
    isAncestorOf: function isAncestorOf(a, b, c) {
    ...
    insertAfter: g,
    splitDataNode: function splitDataNode(a, b) {
      var c = a.cloneNode(!1);
      c.deleteData(0, b);
    ...
    getWindow: function getWindow(a) {
      a = i(a);
      if (_typeof(a.defaultView) != p) return a.defaultView;
      if (_typeof(a.parentWindow) != p) return a.parentWindow;
      throw Error("Cannot get a window object for node");
    },
    getIframeWindow: function getIframeWindow(a) {
      if (_typeof(a.contentWindow) != p) return a.contentWindow;
      if (_typeof(a.contentDocument) != p) return a.contentDocument.defaultView;
      throw Error("getIframeWindow: No Window object found for iframe element");
    },
    getIframeDocument: function getIframeDocument(a) {
      if (_typeof(a.contentDocument) != p) return a.contentDocument;
      if (_typeof(a.contentWindow) != p) return a.contentWindow.document;
      throw Error("getIframeWindow: No Document object found for iframe element");
    },
    getBody: function getBody(a) {
      return q.isHostObject(a, "body") ? a.body : a.getElementsByTagName("body")[0];
    },
    getRootContainer: function getRootContainer(a) {
    ...
    comparePoints: function comparePoints(b, c, h, j) {
      var k;
    ...
    inspectNode: h,
    fragmentFromNodeChildren: function fragmentFromNodeChildren(a) {
    ...
    createIterator: function createIterator(a) {
      return new k(a);
    },
    DomPosition: j
  };
...
rangy.createModule("DomRange", function (b) {
  ...
  function d(a, b, c) {
    if (b = a._listeners[b]) for (var d = 0, h = b.length; d < h; ++d) {
      b[d].call(a, {
        target: a,
        args: c
      });
  ...
  function h(a, b, c) {
    for (var d, e, c = c || {
      ...
      } else for (d = l.createIterator(d); e = d.next();) {
        if (!1 === b(e)) {
          c.stop = !0;
          return;
        }
  ...
  var T = "startContainer startOffset endContainer endOffset collapsed commonAncestorContainer".split(" "),
      ...
      R = 3;
  D.prototype = {
    attachListener: function attachListener(a, b) {
    ...
    intersectsNode: function intersectsNode(b, c) {
      v(this);
      t(b, "NOT_FOUND_ERR");
    ...
    intersectsRange: function intersectsRange(b, c) {
      v(this);
    ...
    createNodeIterator: function createNodeIterator(a, b) {
      v(this);
...
rangy.createModule("WrappedSelection", function (b, c) {
  ...
  function r(a) {
    ...
    if ("undefined" != typeof a.rangeCount) for (var h = 0, j = a.rangeCount; h < j; ++h) {
  ...
  var B;
  s.isHostMethod(t, "getRangeAt") ? B = function B(a, b) {
    try {
  ...
  };else if (s.isHostMethod(t, "getRangeAt") && "number" == typeof t.rangeCount) G = function G(a) {
  ...
  };else if (E && "boolean" == typeof t.isCollapsed && "boolean" == typeof K.collapsed && b.features.implementsDomRange) G = function G(a) {
    var b;
    b = a.nativeSelection;
  ...
  var H;
  !D && E && b.features.implementsDomRange ? (H = function H(a) {
    var b = false;
...
Base = Base.extend({
  ...
  ancestor: Object,
  version: "1.1",
  forEach: function forEach(b, c, a) {
    for (var d in b) {
  ...
  implement: function implement() {
    for (var b = 0; b < arguments.length; b++) {
      if ("function" == typeof arguments[b]) arguments[b](this.prototype);else this.prototype.extend(arguments[b]);
    }
...
wysihtml5.browser = function () {
  ...
  return {
    ...
    crashesWhenDefineProperty: function crashesWhenDefineProperty(b) {
...
wysihtml5.lang.Dispatcher = Base.extend({
  ...
  stopObserving: function stopObserving(b, c) {
    this.events = this.events || {};
    var a = 0,
        d,
        e;
...
(function () {
  ...
  wysihtml5.lang.string = function (a) {
    ...
    return {
      ...
      interpolate: function interpolate(b) {
        for (var c in b) {
...
(function (b) {
  var c = ["-webkit-box-sizing", "-moz-box-sizing", "-ms-box-sizing", "box-sizing"],
    ...
    a: for (var f = 0, g = c.length; f < g; f++) {
      if ("border-box" === b.getStyle(c[f]).from(_a)) {
        e = c[f];
        break a;
      }
    }

    return e ? parseInt(b.getStyle("width").from(_a), 10) < _a.offsetWidth : !1;
  };
...
wysihtml5.dom.getAsDom = function () {
  ...
  return function (c, a) {
    var a = a || document,
        d;
    if ("object" === _typeof(c) && c.nodeType) d = a.createElement("div"), d.appendChild(c);else if (wysihtml5.browser.supportsHTML5Tags(a)) d = a.createElement("div"), d.innerHTML = c;else {
      d = a;
...
wysihtml5.dom.insert = function (b) {
  return {
    after: function after(c) {
      c.parentNode.insertBefore(b, c.nextSibling);
    },
    before: function before(c) {
      c.parentNode.insertBefore(b, c);
    },
    into: function into(c) {
      c.appendChild(b);
    }
  };
};
...
wysihtml5.dom.observe = function (b, c, a) {
  for (var c = "string" === typeof c ? [c] : c, d, e, f = 0, g = c.length; f < g; f++) {
    e = c[f], b.addEventListener ? b.addEventListener(e, a, !1) : (d = function d(c) {
...
(function (b) {
  ...
  b.dom.Sandbox = Base.extend({
    constructor: function constructor(a, c) {
    ...
    _getHtml: function _getHtml(a) {
      var c = a.stylesheets,
          d = "",
          e = 0,
          k;
      if (c = "string" === typeof c ? [c] : c) for (k = c.length; e < k; e++) {
    ...
    _unset: function _unset(a, c, d, e) {
      try {
        a[c] = d;
      } catch (k) {}
...
wysihtml5.dom.setStyles = function (b) {
  return {
    on: function on(c) {
      c = c.style;
      if ("string" === typeof b) c.cssText += ";" + b;else for (var a in b) {
...
(function (b) {
  ...
  b.Selection = Base.extend({
    ...
    executeAndRestore: function executeAndRestore(a, c) {
      var e = this.doc.body,
          f = c && e.scrollTop,
          g = c && e.scrollLeft,
    ...
    executeAndRestoreSimple: function executeAndRestoreSimple(a) {
      var b,
          c,
          f = this.getRange(),
          g = this.doc.body,
...
(function (b, c) {
  ...
  f.prototype = {
    getAncestorWithClass: function getAncestorWithClass(a) {
      for (var d; a;) {
        if (this.cssClass) {
    ...
    getAdjacentMergeableTextNode: function getAdjacentMergeableTextNode(a, c) {
    ...
    areElementsMergeable: function areElementsMergeable(a, b) {
      var d;
    ...
    undoToRange: function undoToRange(a) {
      var c = a.getNodes([b.TEXT_NODE]),
          d,
          e;
    ...
    selectNode: function selectNode(a, c) {
    ...
    isAppliedToRange: function isAppliedToRange(a) {
      var c = [],
          d,
...
(function (b) {
  b.commands.bold = {
    exec: function exec(c, a) {
      return b.commands.formatInline.exec(c, a, "b");
    },
    state: function state(c, a) {
...
(function (b) {
  ...
  b.commands.formatBlock = {
    ...
    state: function state(a, b, c, d, e) {
...
(function (b) {
  b.commands.insertImage = {
    exec: function exec(c, a, d) {
      var d = "object" === _typeof(d) ? d : {
        src: d
      },
          e = c.doc,
          a = this.state(c),
...
wysihtml5.views.View = Base.extend({
  constructor: function constructor(b, c, a) {
    this.parent = b;
    this.element = c;
    this.config = a;
...
(function (b) {
  b.views.Synchronizer = Base.extend({
    constructor: function constructor(b, a, d) {
      this.editor = b;
      this.textarea = a;
      this.composer = d;
    ...
    fromComposerToTextarea: function fromComposerToTextarea(c) {
      this.textarea.setValue(b.lang.string(this.composer.getValue()).trim(), c);
    },
    fromTextareaToComposer: function fromTextareaToComposer(b) {
  ...
  b.toolbar.Dialog = b.lang.Dispatcher.extend({
    ...
    _observe: function _observe() {
      if (!this._observed) {
        ...
        for (var e = this.container.querySelectorAll("input, select, textarea"), f = 0, g = e.length, i = function i() {
    ...
    _serialize: function _serialize() {
      for (var a = this.elementToChange || {}, b = this.container.querySelectorAll("[data-wysihtml5-dialog-field]"), c = b.length, f = 0; f < c; f++) {
...
(function (b) {
  ...
  b.toolbar.Toolbar = Base.extend({
    ...
    _getLinks: function _getLinks(a) {
      for (var c = this[a + "Links"] = b.lang.array(this.container.querySelectorAll("[data-wysihtml5-" + a + "]")).get(), e = c.length, f = 0, g = this[a + "Mapping"] = {}, i, h, k, j, n; f < e; f++) {
        i = c[f], k = i.getAttribute("data-wysihtml5-" + a), j = i.getAttribute("data-wysihtml5-" + a + "-value"), h = this.container.querySelector("[data-wysihtml5-" + a + "-group='" + k + "']"), n = this._getDialog(i, k), g[k + ":" + j] = {
          link: i,
          group: h,
          name: k,
          value: j,
    ...
    _getDialog: function _getDialog(a, c) {
      var e = this,
...
(function (b) {
  ...
  b.Editor = b.lang.Dispatcher.extend({
    constructor: function constructor(a, d) {
    ...
    parse: function parse(a) {
      ...
      "object" === _typeof(a) && b.quirks.redraw(a);
      return c;
    },
