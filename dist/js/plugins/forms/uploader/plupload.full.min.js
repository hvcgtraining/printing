...
!function (e, t) {
  ...
  i(u, [], function () {
    var e = function e(_e) {
      var t;
      return _e === t ? "undefined" : null === _e ? "null" : _e.nodeType ? "node" : {}.toString.call(_e).match(/\s([a-z|A-Z]+)/)[1].toLowerCase();
    },
        t = function t(i) {
      var r;
      ...
      var r = 0,
          o = t.length;
      "function" !== e(n) && (n = function n() {}), t && t.length || n(), i(r);
    },
        o = function o(e, t) {
      var i = 0,
          r = e.length,
        ...
        rgx: function rgx() {
          for (var t, n = 0, a, s, u, c, l, d, f = arguments; n < f.length; n += 2) {
            ...
            if (_typeof(t) === r) {
              ...
              for (u in h) {
                c = h[u], _typeof(c) === o ? t[c[0]] = e : t[c] = e;
              }
            }
            ...
            for (a = s = 0; a < p.length; a++) {
              if (l = p[a].exec(this.getUA())) {
                for (u = 0; u < h.length; u++) {
                  d = l[++s], c = h[u], _typeof(c) === o && c.length > 0 ? 2 == c.length ? t[c[0]] = _typeof(c[1]) == i ? c[1].call(this, d) : c[1] : 3 == c.length ? t[c[0]] = _typeof(c[1]) !== i || c[1].exec && c[1].test ? d ? d.replace(c[1], c[2]) : e : d ? c[1].call(this, d, c[2]) : e : 4 == c.length && (t[c[0]] = d ? c[3].call(this, d.replace(c[1], c[2])) : e) : t[c] = d ? d : e;
                }
    ...
    var e = function e(_e2) {
      ...
      return decodeURIComponent(escape(e));
        ...
        n = function n(e, _n) {
      if ("function" == typeof window.atob) return _n ? t(window.atob(e)) : window.atob(e);
      ...
      do {
        s = i.indexOf(e.charAt(f++)), u = i.indexOf(e.charAt(f++)), c = i.indexOf(e.charAt(f++)), l = i.indexOf(e.charAt(f++)), d = s << 18 | u << 12 | c << 6 | l, r = 255 & d >> 16, o = 255 & d >> 8, a = 255 & d, m[p++] = 64 == c ? String.fromCharCode(r) : 64 == l ? String.fromCharCode(r, o) : String.fromCharCode(r, o, a);
      } while (f < e.length);

      return h = m.join(""), _n ? t(h) : h;
    },
        i = function i(t, n) {
      ...
      do {
        r = t.charCodeAt(f++), o = t.charCodeAt(f++), a = t.charCodeAt(f++), d = r << 16 | o << 8 | a, s = 63 & d >> 18, u = 63 & d >> 12, c = 63 & d >> 6, l = 63 & d, m[p++] = i.charAt(s) + i.charAt(u) + i.charAt(c) + i.charAt(l);
      } while (f < t.length);
    ...
    function u(n) {
      ...
      }, n = "object" == _typeof(n) ? i.extend({}, u, n) : u, n.container = t.get(n.drop_zone) || document.body, "static" === t.getStyle(n.container, "position") && (n.container.style.position = "relative"), "string" == typeof n.accept && (n.accept = s.mimes2extList(n.accept)), o.call(a), i.extend(a, {
        uid: i.guid("uid_"),
        ruid: null,
        files: null,
        init: function init() {
    ...
    function r() {
      ...
      n.call(this), e.extend(this, {
        ...
        state: r.IDLE,
        result: null,
        transport: function transport(t, n, r) {
          var a = this;
          if (r = e.extend({
            chunk_size: 204798
    ...
    function p() {
      ...
      a.call(this), e.extend(this, {
        ...
        downsize: function downsize(t, i, r, o) {
          try {
    ...
    var i = {},
      ...
      var c, l;
      a = a.toLowerCase(), _o.addEventListener ? (c = s, _o.addEventListener(a, c, !1)) : _o.attachEvent && (c = function c() {
        var e = window.event;
        e.target || (e.target = e.srcElement), e.preventDefault = t, e.stopPropagation = n, s(e);
      }, _o.attachEvent("on" + a, c)), _o[r] || (_o[r] = e.guid()), i.hasOwnProperty(_o[r]) || (i[_o[r]] = {}), l = i[_o[r]], l.hasOwnProperty(a) || (l[a] = []), l[a].push({
        func: c,
        orig: s,
        key: u
      });
        ...
        for (r = 0; i > r; r++) {
          if (p = f = e + 12 * r + 2, s = n[a.SHORT(p)], s !== t) {
            switch (u = a.SHORT(p += 2), d = a.LONG(p += 2), p += 4, m = [], u) {
              case 1:
              case 7:
                for (d > 4 && (p = a.LONG(p) + c.tiffHeader), o = 0; d > o; o++) {
                  m[o] = a.BYTE(p + o);
                }
              ...
              case 3:
                for (d > 2 && (p = a.LONG(p) + c.tiffHeader), o = 0; d > o; o++) {
                  m[o] = a.SHORT(p + 2 * o);
                }
              ...
              case 4:
                for (d > 1 && (p = a.LONG(p) + c.tiffHeader), o = 0; d > o; o++) {
                  m[o] = a.LONG(p + 4 * o);
                }
            ...
            h = 1 == d ? m[0] : m, g[s] = l.hasOwnProperty(s) && "object" != _typeof(h) ? l[s][h] : h;
          }
        }
    ...
    var n = {
      getAsBlob: function getAsBlob(e) {
        var n = this.getRuntime(),
      ...
      getInfo: function getInfo() {
        ...
        return r.meta && t.each(n, function (e) {
          var t = r.meta[e],
              ...
              a,
              s;
          if (t && t.keys) for (i.meta[e] = {}, o = 0, a = t.keys.length; a > o; o++) {
...
(function () {
  ...
  return function n(r) {
    ...
    for (i in r) {
      s = _typeof(r[i]), s === "object" && !~t(i, ["Exceptions", "Env", "Mime"]) ? n(r[i]) : s === "function" && (e[i] = r[i]);
    }
...
(function (e, t, n) {
  function s(e) {
    ...
    return typeof t == "string" ? o.each(t.split(/\s*,\s*/), function (e) {
      r(e, !0);
    }) : _typeof(t) == "object" ? o.each(t, function (e, t) {
      r(t, e);
  ...
  var r = e.setTimeout,
    ...
    predictRuntime: function predictRuntime(e, n) {
      var r, i;
  ...
  o.addFileFilter("mime_types", function (e, t, n) {
    ...
    function N(e, n, r) {
      ...
      var i = this,
          u = !1;
      _typeof(e) == "object" ? o.each(e, function (e, t) {
        f(t, e, r);
