...
$(function () {
  ...
  $('.datatable table').dataTable(); //===== Datatable with pager =====//
  ...
  */
  ...
  $("#max-amount, #max-amount1").val($("#slider-range-max, #slider-range-max1").slider("value")); //===== Spinner options =====//
  ...
  $('.elastic').autosize(); //===== Dual select boxes =====//

  $.configureBoxes(); //===== Input limiter =====//
  ...
  $('.switch').bootstrapSwitch(); //===== Fullcalendar =====//
  ...
  window.prettyPrint && prettyPrint(); //===== Time pickers =====//
  ...
  $('.page-content').wrapInner('<div class="page-content-inner"></div>'); //===== Applying offcanvas class =====//
